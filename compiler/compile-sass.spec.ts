...
describe('compileSass', () => {
  ...
  beforeEach(() => {
    files = { './stylesheets/src/modules/_color.scss': '' }
    mock(files)
  })
  ...
  it('compiles Sass color variables', () => {
    ...
    compileSass(data)
    const check = readFileSync('./stylesheets/src/modules/_color.scss', { encoding: 'utf8' })
  ...
  it('compiles Sass spacing variables', () => {
    ...
    compileSass(data)
    const check = readFileSync('./stylesheets/src/modules/_spacing.scss', { encoding: 'utf8' })
  ...
  it('compiles Sass breakpoint variables', () => {
    ...
    compileSass(data)
    const check = readFileSync('./stylesheets/src/modules/_breakpoints.scss', { encoding: 'utf8' })
  ...
  it('compiles Sass font variables', () => {
    ...
    compileSass(data)
    const check = readFileSync('./stylesheets/src/modules/_fonts.scss', { encoding: 'utf8' })
